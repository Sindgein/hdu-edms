    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grades', models.CharField(blank=True, max_length=100, verbose_name='题目')),
            ],
            options={
                'verbose_name': '学生',
        ...
        migrations.AddField(
            model_name='student',
            name='teacher',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='ums.Teacher'),
        ),
        migrations.AddField(
            model_name='student',
            name='user',
